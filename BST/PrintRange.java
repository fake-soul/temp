...
public class PrintRange
{
	...
	void RangeFun(Node root,int k1,int k2)
	{
		if(root==null)
			return;
		...
		while(!queue.isEmpty())
		{
			...
			if(tempNode.data>k1 && tempNode.data<k2)
			{
				System.out.print(tempNode.data+" ");
			}
			if(tempNode.left!=null && tempNode.data>k1)
				queue.add(tempNode.left);
			if(tempNode.right!=null && tempNode.data<k2)
